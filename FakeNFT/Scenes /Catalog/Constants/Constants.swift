...
struct Constants {
    ...
    static let likeButtonInsetsLeft: CGFloat = 9
    static let likeButtonInsetsRight: CGFloat = 10
    static let likeButtonTopIdent: CGFloat = -2
    static let likeButtonTrailing: CGFloat = 2
    static let likeButtonHeigthWidth: CGFloat = 40
    
    static let ratingViewTopIdent: CGFloat = 8
    static let ratingViewHeigth: CGFloat = 12
    static let ratingViewWidth: CGFloat = 70
    
    static let nftNameTopIdent: CGFloat = 4
    static let nftNameHeigth: CGFloat = 22
    static let nftNameWidth: CGFloat = 68
    ...
    static let collectionNameLeading: CGFloat = 16
    ...
    static let nftCollectionViewTopIdent: CGFloat = 24
    static let nftCollectionViewLeading: CGFloat = 16
    static let nftCollectionViewTrailing: CGFloat = -16
    
    static let collectionViewminimumLineSpacingForSectionAt: CGFloat = 9
    static let collectionViewminimumInteritemSpacingForSectionAt: CGFloat = 8
}
